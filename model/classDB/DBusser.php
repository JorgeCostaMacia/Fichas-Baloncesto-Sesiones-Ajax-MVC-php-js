...
class DBusser extends DBquery {
    ...
    function __construct($_database, $_password = "", $_host = "localhost", $_username = "root") {
        $this->_host = $_host;
        $this->_username = $_username;
        $this->_password = $_password;
        $this->_database = $_database;
        $this->_connection = DBconnection::getConnection($_database, $_password, $_host, $_username);
    }
